<footer class="footer-area section_gap" style="margin-top: 20px;">
		<div class="container">
			<div class="row">
						...
						<div class="" id="mc_embed_signup">
							...
							<form target="_blank" novalidate="true" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get" class="form-inline">
								...
								<div class="d-flex flex-row">
									...
									<input class="form-control" name="EMAIL" placeholder="Enter Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập e-mail của bạn '" required="" type="email">
			...
			<div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
				<p class="footer-text m-0">
					...
					KARMAR &copy;
					<script>document.write(new Date().getFullYear());</script> All Design hot | KarmaSneaker
